  ...
  return (
    <div>
      ...
      >
        ...
        >
          <h1 className="h1Tag">
            <span classname="sb-searchbox__title-text">Car hire in London</span>
          </h1>

          <h2 className="h2Tag">Find great car deals for your trip in London</h2>
          <br />
          <br />
          <Flex style={{ gap: "10px" }}>
            <input type="radio" />
      ...
      {/* //Recommended pick-up locations in London */}
      <br />
      <Box width={"80%"} margin="auto">
        <Text textAlign={"left"} fontWeight="700" fontSize={"2xl"}>
          Recommended pick-up locations in London
      ...
      {/* //Car hire destinations near London */}
      <br />
      <FrequentAsk />
      <br />
      <Box width={"80%"} margin="auto">
        <Text fontSize="2xl" style={{ textAlign: "left", fontWeight: "700" }}>
          Popular car rental destinations in the United Kingdom
        </Text>
      </Box>
      <br />
