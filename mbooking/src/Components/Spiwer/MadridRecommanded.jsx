      ...
      >
        <SwiperSlide  style={{border:"1px solid black",borderRadius:"7px"}} >
          <Box style={{height:"120px",width:"80%",margin:"auto"}}>
            ...
            >
              Car hire at Madrid City Airpot
            </h2>
            <Text
              lineHeight={"24px"}
              fontWeight="400"
        ...
        <SwiperSlide  style={{border:"1px solid black",borderRadius:"7px"}}  >
          <Box  style={{height:"120px",width:"80%",margin:"auto"}}  >
            <h2
              style={{ textAlign: "left", fontSize: "22px", fontWeight: "700" }}
            >
              Car hire at Madrid Stansted Airpot
            </h2>
            <Text
              lineHeight={"24px"}
              fontWeight="400"
        ...
        <SwiperSlide style={{border:"1px solid black",borderRadius:"7px"}}   >
          <Box   style={{height:"120px",width:"80%",margin:"auto"}}  >
            <h2
              style={{ textAlign: "left", fontSize: "22px", fontWeight: "700" }}
            >
              Car hire at Madrid -Sephard Bush
            </h2>
            <Text
              lineHeight={"24px"}
              fontWeight="400"
        ...
        <SwiperSlide style={{border:"1px solid black",borderRadius:"7px"}}   >
          <Box   style={{height:"120px",width:"80%",margin:"auto"}}  >
            <h2
              style={{ textAlign: "left", fontSize: "22px", fontWeight: "700" }}
            >
              Car hire at Madrid -Russel Square
            </h2>
            <Text
              lineHeight={"24px"}
              fontWeight="400"
