  ...
  return (
    <div style={{ width: "80%", margin: "auto" }}>
      ...
      <div style={{ width: "100%" }} className="corona">
        <p>
          {" "}
          <InfoOutlineIcon w={5} h={8} color="red.500" marginRight="8px" />{" "}
      ...
      <Heading textAlign={"left"} mt={"30px"} mb={"10px"} size={"lg"}>
        Offers
      </Heading>
      <Heading textAlign={"left"} size={"sm"} color={"grey"} mb={"10px"}>
      ...
      >
        ...
        >
          <Box textAlign={"left"}>
            ...
            <Heading size={"sm"} mb={"10px"} color={"grey"}>
              Get inspired, compare and book flights with <br /> more
              flexibility
            </Heading>
        ...
        >
          <Box textAlign={"left"} position={"absolute"} p={"20px"}>
            <Heading size={"sm"} mb={"10px"} color={"white"}>
              Escape for a while
            </Heading>
            <Heading size={"sm"} mb={"10px"} color={"white"}>
              Enjoy the freedom of a monthly stay on <br /> Booking.com
            </Heading>
      ...
      >
        ...
        <Box w={"auto%"}>
          ...
          <Image
            width={"100%"}
            height={"260px"}
            src="https://cf.bstatic.com/xdata/images/city/600x600/824928.jpg?k=021c9ec0c9e01c06f47809fe251701390100d0f446b4edc47027d1a0c029f638&o="
            alt="Manesar"
          />
        </Box>
      </Box>
      ...
      >
        ...
        <Box w={"auto%"}>
          ...
          <Image
            width={"100%"}
            height={"260px"}
            src="https://cf.bstatic.com/xdata/images/city/600x600/935891.jpg?k=05668cbae7eaa0f13b675a0c91164465bdc3394db46c6bb555e9dacdbbc4c025&o="
            alt="Neemrana"
          />
        </Box>
      </Box>
