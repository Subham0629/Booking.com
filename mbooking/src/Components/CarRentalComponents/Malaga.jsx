...
const Malaga = () => {
  ...
  return (
    <div>
      ...
      {/* //Recommended pick-up locations in Malaga */}
      <br />
      <Box width={"80%"} margin="auto">
        <Text textAlign={"left"} fontWeight="700" fontSize={"2xl"}>
          Recommended pick-up locations in Malaga
      ...
      <br/>
      <Box>
        <Image src="https://user-images.githubusercontent.com/106021674/228821498-71232ec0-6643-41e3-bdf6-0e665e276f00.png" alt="cancellation" />
      </Box>
      {/* //Car hire destinations near Malaga */}
      <br />
      <FrequentAsk/>
      <br />
      <Box width={"80%"} margin="auto">
        <Text   fontSize="2xl"   style={{ textAlign: "left",fontWeight:"700" }}>
          Popular car rental destinations in the Malaga
        </Text>
      </Box>
      <br/>
      <Box
