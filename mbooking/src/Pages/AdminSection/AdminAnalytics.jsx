...
import { popularFligthData } from "../../Redux/flightReducer/action";
...
export const AdminAnalytics = () => {
  ...
  const flightLength = useSelector((state) => state.flightReducer);
    ...
    <Box >
      <Flex >
        ...
        <Box width={"80%"} style={{backgroundColor:"#001f49"}} >
          <Image height={"60%"} src="https://user-images.githubusercontent.com/106021674/229345830-28029438-079b-4618-a77e-580804ed7480.png" alt="pie" borderRadius={"12px 20px"}   />
          <br/>
          <Flex
